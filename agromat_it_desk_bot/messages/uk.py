...
UK: Mapping[Msg, str] = {
    ...
    Msg.CONNECT_START_REGISTERED: (
        ...
        'Зміна суфіксу повідомлення /setsuffix.'
    ),
    Msg.CONNECT_HELP: (
    ...
    Msg.SUFFIX_USAGE: '📋 <b>Формат:</b> /setsuffix <code>&lt;суфікс&gt;</code>.',
    Msg.SUFFIX_UPDATED: '✨ Готово! Новий суфікс повідомлення:\n{value}',
    Msg.ERR_COMMAND_UNAVAILABLE: '❌ Немає доступу до цієї команди.',
