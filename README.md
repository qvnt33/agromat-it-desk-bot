...
2. FastAPI-бекенд формує повідомлення, зберігає зв’язок `issue_id ↔ message_id` у MySQL (або тестову SQLite) та публікує запис у Telegram (Aiogram).
3. **Кнопка «Прийняти»**:
...
| `MYSQL_CHARSET`     | кодування з’єднання (default: `utf8mb4`)                          |
...
- Для повного ресету середовища у MySQL видаліть таблиці/базу `support`; тести локально можуть використовувати тимчасову SQLite.
